...
export const translations = {
  en: {
    ...
    hero: {
      ...
      badge: "Android beta open · looking for testers",
      eyebrow: "Local-first spreadsheet workspace",
      title: "Turn your Excel files into a local SQL database.",
      titleAccent: "local SQL database",
      copy: "Import CSV and Excel once, then filter, query with SQL, chart, and export — fully offline, with nothing ever uploaded.",
    ...
    trailer: {
      ...
      stepsLabel: "How to join the Android beta",
      steps: [
        { title: "Write to me", text: "Send an email or a message on any profile below. There is no form to fill in." },
        { title: "Get the invite", text: "I add your Google account to the closed test and send you the Play Store link." },
        { title: "Use it for 14 days", text: "Install the build, open your real files, and tell me what breaks." },
      ],
      privacyTitle: "Why there is no signup form",
      privacyText: "Exlser keeps your data on your device, and this page follows the same rule: no form, no database behind it. Write to me directly and nothing about you is stored anywhere.",
    },
    legacy: {
    ...
    crossPlatform: {
      ...
      alt: "Exlser running across phone, desktop, tablet, and web devices", iosNote: "iOS is on the roadmap. The app already runs on Flutter — with enough interest from testers, an App Store release follows (only the Apple Developer account is left to set up).",
    },
    downloads: {
      eyebrow: "Get Exlser",
      title: "Choose the channel that fits your device.",
      desktop: { for: "Download for", generic: "Download for desktop", others: "Other platforms", all: "All versions" },
      channels: [
        {
          title: "Android beta",
  ...
  it: {
    ...
    hero: {
      ...
      badge: "Beta Android aperta · cerco tester",
      eyebrow: "Workspace locale per fogli di calcolo",
      title: "Trasforma i tuoi file Excel in un database SQL locale.",
      titleAccent: "database SQL locale",
      copy: "Importa CSV ed Excel una sola volta, poi filtra, interroga con SQL, crea grafici ed esporta — tutto offline, senza mai caricare nulla.",
    ...
    trailer: {
      ...
      stepsLabel: "Come partecipare alla beta Android",
      steps: [
        { title: "Scrivimi", text: "Mandami una email o un messaggio su uno dei profili qui sotto. Non c'è nessun form da compilare." },
        { title: "Ricevi l'invito", text: "Aggiungo il tuo account Google al test chiuso e ti mando il link dello Play Store." },
        { title: "Usala per 14 giorni", text: "Installa la build, apri i tuoi file veri e raccontami cosa si rompe." },
      ],
      privacyTitle: "Perché non c'è un form di iscrizione",
      privacyText: "Exlser tiene i tuoi dati sul tuo dispositivo, e questa pagina segue la stessa regola: nessun form, nessun database dietro. Scrivimi direttamente e di te non resta memorizzato niente da nessuna parte.",
    },
    legacy: {
    ...
    crossPlatform: {
      ...
      alt: "Exlser in esecuzione su telefono, desktop, tablet e web", iosNote: "iOS è nella roadmap. L'app gira già su Flutter: con abbastanza richieste dai tester attivo la pubblicazione su App Store (manca solo l'account Apple Developer).",
    },
    downloads: {
      eyebrow: "Ottieni Exlser",
      title: "Scegli il canale adatto al tuo dispositivo.",
      desktop: { for: "Scarica per", generic: "Scarica per desktop", others: "Altre piattaforme", all: "Tutte le versioni" },
      channels: [
        {
          title: "Beta Android",
  ...
  es: {
    ...
    hero: {
      ...
      badge: "Beta Android abierta · busco testers",
      eyebrow: "Espacio de trabajo local para hojas de cálculo",
      title: "Tus hojas de cálculo, exploradas como una base de datos.",
      titleAccent: "como una base de datos",
    ...
    trailer: {
      ...
      stepsLabel: "Cómo unirse a la beta de Android",
      steps: [
        { title: "Escríbeme", text: "Envíame un correo o un mensaje en cualquiera de los perfiles de abajo. No hay ningún formulario que rellenar." },
        { title: "Recibe la invitación", text: "Añado tu cuenta de Google a la prueba cerrada y te mando el enlace de Play Store." },
        { title: "Úsala 14 días", text: "Instala la build, abre tus archivos reales y cuéntame qué falla." },
      ],
      privacyTitle: "Por qué no hay formulario de registro",
      privacyText: "Exlser mantiene tus datos en tu dispositivo y esta página sigue la misma regla: sin formulario y sin base de datos detrás. Escríbeme directamente y no se guarda nada sobre ti en ningún sitio.",
    },
    legacy: {
    ...
    crossPlatform: {
      ...
      alt: "Exlser funcionando en teléfono, escritorio, tablet y web", iosNote: "iOS está en la hoja de ruta. La app ya funciona con Flutter: con suficiente interés de los testers activo la publicación en la App Store (solo falta la cuenta de Apple Developer).",
    },
    downloads: {
      eyebrow: "Obtén Exlser",
      title: "Elige el canal que encaja con tu dispositivo.",
      desktop: { for: "Descargar para", generic: "Descargar para escritorio", others: "Otras plataformas", all: "Todas las versiones" },
      channels: [
  ...
  fr: {
    ...
    hero: {
      ...
      badge: "Bêta Android ouverte · je cherche des testeurs",
      eyebrow: "Espace de travail local pour tableurs",
      title: "Vos tableurs, explorés comme une base de données.",
      titleAccent: "comme une base de données",
    ...
    trailer: { eyebrow: "Bêta mobile", title: "Rejoignez la bêta mobile et découvrez la suite.", text: "La vidéo montre l'expérience mobile prévue : importer des fichiers, vérifier les données, explorer les analyses et travailler localement sur votre appareil.", betaCta: "Demander l'accès bêta", moreInfo: "Obtenir plus d'informations",
      stepsLabel: "Comment rejoindre la bêta Android",
      steps: [
        { title: "Écrivez-moi", text: "Envoyez un e-mail ou un message sur l'un des profils ci-dessous. Aucun formulaire à remplir." },
        { title: "Recevez l'invitation", text: "J'ajoute votre compte Google au test fermé et je vous envoie le lien Play Store." },
        { title: "Utilisez-la 14 jours", text: "Installez la build, ouvrez vos vrais fichiers et dites-moi ce qui casse." },
      ],
      privacyTitle: "Pourquoi il n'y a pas de formulaire",
      privacyText: "Exlser garde vos données sur votre appareil, et cette page suit la même règle : aucun formulaire, aucune base de données derrière. Écrivez-moi directement, rien vous concernant n'est stocké.",
    },
    ...
    crossPlatform: { eyebrow: "Plan multiplateforme", title: "Un flux de données, plusieurs appareils.", text: "Exlser est développé avec Flutter pour Android, desktop et web. La bêta Android passe par Google Play, les builds desktop par GitHub Releases.", alt: "Exlser sur téléphone, desktop, tablette et web", iosNote: "iOS est prévu. L'app tourne déjà sous Flutter : avec assez d'intérêt des testeurs, une publication sur l'App Store suit (il ne reste que le compte Apple Developer)." },
    downloads: {
      eyebrow: "Obtenir Exlser",
      title: "Choisissez le canal adapté à votre appareil.",
      desktop: { for: "Télécharger pour", generic: "Télécharger pour desktop", others: "Autres plateformes", all: "Toutes les versions" },
      channels: [
  ...
  de: {
    ...
    hero: {
      ...
      badge: "Android-Beta offen · Tester gesucht",
      eyebrow: "Lokaler Workspace für Tabellen",
      title: "Deine Tabellen, erkundet wie eine Datenbank.",
      titleAccent: "wie eine Datenbank",
    ...
    trailer: { eyebrow: "Mobile Beta", title: "Mach bei der mobilen Beta mit und sieh, was kommt.", text: "Das Video zeigt die geplante mobile Erfahrung: Dateien importieren, Daten prüfen, Analysen erkunden und lokal auf deinem Gerät arbeiten.", betaCta: "Beta-Zugang anfragen", moreInfo: "Mehr Informationen",
      stepsLabel: "So kommst du in die Android-Beta",
      steps: [
        { title: "Schreib mir", text: "Schick eine E-Mail oder eine Nachricht über eines der Profile unten. Kein Formular auszufüllen." },
        { title: "Einladung erhalten", text: "Ich füge dein Google-Konto zum geschlossenen Test hinzu und schicke dir den Play-Store-Link." },
        { title: "14 Tage nutzen", text: "Installiere den Build, öffne deine echten Dateien und sag mir, was kaputtgeht." },
      ],
      privacyTitle: "Warum es kein Anmeldeformular gibt",
      privacyText: "Exlser behält deine Daten auf deinem Gerät, und diese Seite folgt derselben Regel: kein Formular, keine Datenbank dahinter. Schreib mir direkt — über dich wird nichts gespeichert.",
    },
    ...
    crossPlatform: { eyebrow: "Cross-Platform-Plan", title: "Ein Datenworkflow, viele Geräte.", text: "Exlser wird mit Flutter für Android, Desktop und Web entwickelt. Die Android-Beta läuft über Google Play, Desktop-Builds über GitHub Releases.", alt: "Exlser auf Smartphone, Desktop, Tablet und Web", iosNote: "iOS ist geplant. Die App läuft bereits mit Flutter — bei genug Interesse der Tester folgt ein App-Store-Release (es fehlt nur das Apple-Developer-Konto)." },
    downloads: {
      eyebrow: "Exlser erhalten",
      title: "Wähle den passenden Kanal für dein Gerät.",
      desktop: { for: "Herunterladen für", generic: "Für Desktop herunterladen", others: "Andere Plattformen", all: "Alle Versionen" },
      channels: [
  ...
  zh: {
    ...
    hero: {
      aria: "Exlser 产品概览",
      badge: "Android 测试版开放 · 招募测试者",
      eyebrow: "本地优先的表格数据工作区",
      title: "把你的表格，当作数据库来探索。",
      titleAccent: "当作数据库",
    ...
    trailer: { eyebrow: "移动端测试版", title: "加入移动端测试，看看即将上线的体验。", text: "视频展示了预期的移动端体验：导入文件、检查数据、查看分析，并在设备本地完成工作。", betaCta: "申请测试资格", moreInfo: "获取更多信息",
      stepsLabel: "如何加入 Android 测试版",
      steps: [
        { title: "给我写信", text: "通过下方任一渠道发邮件或私信。无需填写任何表单。" },
        { title: "收到邀请", text: "我会把你的 Google 账号加入封闭测试，并发送 Play 商店链接。" },
        { title: "使用 14 天", text: "安装版本，打开你真实的文件，告诉我哪里出了问题。" },
      ],
      privacyTitle: "为什么没有注册表单",
      privacyText: "Exlser 把数据留在你的设备上，这个页面遵循同样的规则：没有表单，背后也没有数据库。直接联系我，关于你的信息不会被存储在任何地方。",
    },
    ...
    crossPlatform: { eyebrow: "跨平台计划", title: "一个数据流程，多种设备。", text: "Exlser 使用 Flutter 开发，面向 Android、桌面和 Web。Android 测试版通过 Google Play 分发，桌面版本通过 GitHub Releases 发布。", alt: "Exlser 在手机、桌面、平板和网页上运行", iosNote: "iOS 已在计划中。应用已基于 Flutter 运行——只要测试者有足够的需求，就会发布到 App Store（只差一个 Apple Developer 账号）。" },
    downloads: {
      eyebrow: "获取 Exlser",
      title: "选择适合你设备的渠道。",
      desktop: { for: "下载", generic: "下载桌面版", others: "其他平台", all: "所有版本" },
      channels: [
  ...
  ru: {
    ...
    hero: {
      ...
      badge: "Android beta открыта · ищу тестеров",
      eyebrow: "Локальное рабочее пространство для таблиц",
      title: "Ваши таблицы, исследуемые как база данных.",
      titleAccent: "как база данных",
    ...
    trailer: { eyebrow: "Мобильная beta", title: "Присоединяйтесь к мобильной beta и посмотрите, что будет дальше.", text: "Видео показывает ожидаемый мобильный опыт: импорт файлов, просмотр данных, аналитика и локальная работа на вашем устройстве.", betaCta: "Запросить доступ к beta", moreInfo: "Получить больше информации",
      stepsLabel: "Как присоединиться к Android beta",
      steps: [
        { title: "Напишите мне", text: "Отправьте письмо или сообщение в любом профиле ниже. Никаких форм заполнять не нужно." },
        { title: "Получите приглашение", text: "Я добавлю ваш аккаунт Google в закрытый тест и пришлю ссылку на Play Store." },
        { title: "Используйте 14 дней", text: "Установите сборку, откройте свои реальные файлы и расскажите, что ломается." },
      ],
      privacyTitle: "Почему здесь нет формы регистрации",
      privacyText: "Exlser хранит ваши данные на вашем устройстве, и эта страница следует тому же правилу: ни формы, ни базы данных за ней. Напишите мне напрямую — о вас нигде ничего не сохраняется.",
    },
    ...
    crossPlatform: { eyebrow: "Кроссплатформенный план", title: "Один поток данных, много устройств.", text: "Exlser разрабатывается на Flutter для Android, desktop и web. Android beta распространяется через Google Play, desktop-сборки через GitHub Releases.", alt: "Exlser на телефоне, desktop, планшете и web", iosNote: "iOS в планах. Приложение уже работает на Flutter — при достаточном интересе тестеров выйдет релиз в App Store (остаётся только аккаунт Apple Developer)." },
    downloads: {
      eyebrow: "Получить Exlser",
      title: "Выберите канал для вашего устройства.",
      desktop: { for: "Скачать для", generic: "Скачать для desktop", others: "Другие платформы", all: "Все версии" },
      channels: [
  ...
  ja: {
    ...
    hero: {
      aria: "Exlser 製品概要",
      badge: "Android ベータ公開中 · テスター募集",
      eyebrow: "ローカル優先のスプレッドシート作業空間",
      title: "あなたの表計算を、データベースのように探索。",
      titleAccent: "データベースのように",
    ...
    trailer: { eyebrow: "モバイルベータ", title: "モバイルベータに参加して今後の体験を確認。", text: "動画では、ファイルのインポート、データ確認、分析、端末上でのローカル作業というモバイル体験を紹介します。", betaCta: "ベータアクセスを依頼", moreInfo: "詳しい情報を見る",
      stepsLabel: "Android ベータへの参加方法",
      steps: [
        { title: "連絡する", text: "下のいずれかのプロフィールからメールまたはメッセージを送ってください。入力フォームはありません。" },
        { title: "招待を受け取る", text: "あなたの Google アカウントをクローズドテストに追加し、Play ストアのリンクをお送りします。" },
        { title: "14日間使う", text: "ビルドをインストールし、実際のファイルを開いて、壊れた箇所を教えてください。" },
      ],
      privacyTitle: "登録フォームがない理由",
      privacyText: "Exlser はデータを端末内に保持します。このページも同じ方針です。フォームも、その背後のデータベースもありません。直接ご連絡ください。あなたに関する情報はどこにも保存されません。",
    },
    ...
    crossPlatform: { eyebrow: "クロスプラットフォーム計画", title: "1 つのデータ作業を複数の端末で。", text: "Exlser は Flutter で Android、デスクトップ、Web 向けに開発されています。Android ベータは Google Play、デスクトップ版は GitHub Releases で配布されます。", alt: "スマートフォン、デスクトップ、タブレット、Web で動作する Exlser", iosNote: "iOS はロードマップにあります。アプリはすでに Flutter で動作しており、テスターの要望が十分にあれば App Store で公開します（あとは Apple Developer アカウントだけ）。" },
    downloads: {
      eyebrow: "Exlser を入手",
      title: "端末に合うチャンネルを選択してください。",
      desktop: { for: "ダウンロード:", generic: "デスクトップ版をダウンロード", others: "他のプラットフォーム", all: "すべてのバージョン" },
      channels: [
  ...
  pt: {
    ...
    hero: {
      ...
      badge: "Beta Android aberta · procuro testadores",
      eyebrow: "Workspace local para planilhas",
      title: "Suas planilhas, exploradas como um banco de dados.",
      titleAccent: "como um banco de dados",
    ...
    trailer: { eyebrow: "Beta mobile", title: "Participe da beta mobile e veja o que está chegando.", text: "O vídeo mostra a experiência mobile prevista: importar arquivos, revisar dados, explorar análises e trabalhar localmente no seu dispositivo.", betaCta: "Solicitar acesso beta", moreInfo: "Obter mais informações",
      stepsLabel: "Como entrar na beta do Android",
      steps: [
        { title: "Escreva para mim", text: "Envie um e-mail ou uma mensagem em qualquer perfil abaixo. Não há formulário para preencher." },
        { title: "Receba o convite", text: "Adiciono sua conta Google ao teste fechado e envio o link da Play Store." },
        { title: "Use por 14 dias", text: "Instale a build, abra seus arquivos reais e me conte o que quebra." },
      ],
      privacyTitle: "Por que não existe formulário de cadastro",
      privacyText: "O Exlser mantém seus dados no seu dispositivo, e esta página segue a mesma regra: sem formulário e sem banco de dados por trás. Fale comigo diretamente — nada sobre você fica armazenado.",
    },
    ...
    crossPlatform: { eyebrow: "Plano multiplataforma", title: "Um fluxo de dados, muitos dispositivos.", text: "Exlser é desenvolvido com Flutter para Android, desktop e web. A beta Android é distribuída pelo Google Play, e builds desktop pelo GitHub Releases.", alt: "Exlser em celular, desktop, tablet e web", iosNote: "iOS está no roadmap. O app já roda em Flutter — com interesse suficiente dos testadores, sai uma publicação na App Store (falta só a conta Apple Developer)." },
    downloads: {
      eyebrow: "Obter Exlser",
      title: "Escolha o canal adequado ao seu dispositivo.",
      desktop: { for: "Baixar para", generic: "Baixar para desktop", others: "Outras plataformas", all: "Todas as versões" },
      channels: [
